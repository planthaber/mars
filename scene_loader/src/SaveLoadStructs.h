...
namespace mars {
  namespace scene_loader {
    ...
    struct saveStruct_t{
      MarsVector<interfaces::LightData> v_lightList;
      MarsVector<interfaces::JointData> v_jointList;
      MarsVector<interfaces::MotorData> v_motorList;
      std::vector<const interfaces::BaseSensor*> v_sensorList;
      MarsVector<interfaces::ControllerData> v_controllerList;
      MarsVector<interfaces::NodeData> v_nodeList;
    };
